 ...
 */
class DutchStemmer extends BaseStemmer_js_1.BaseStemmer {
    /**
     * Initializes a new instance of the DutchStemmer class.
     */
    constructor() {
        super();
        this.a_0 = [new Among_js_1.Among("", -1, 6), new Among_js_1.Among("\u00E1", 0, 1),
            new Among_js_1.Among("\u00E4", 0, 1), new Among_js_1.Among("\u00E9", 0, 2),
            new Among_js_1.Among("\u00EB", 0, 2), new Among_js_1.Among("\u00ED", 0, 3),
            new Among_js_1.Among("\u00EF", 0, 3), new Among_js_1.Among("\u00F3", 0, 4),
            new Among_js_1.Among("\u00F6", 0, 4), new Among_js_1.Among("\u00FA", 0, 5),
            new Among_js_1.Among("\u00FC", 0, 5)];
        this.a_1 = [new Among_js_1.Among("", -1, 3),
            new Among_js_1.Among("I", 0, 2), new Among_js_1.Among("Y", 0, 1)];
        this.a_2 = [
            new Among_js_1.Among("dd", -1, -1), new Among_js_1.Among("kk", -1, -1),
            new Among_js_1.Among("tt", -1, -1)
        ];
        this.a_3 = [new Among_js_1.Among("ene", -1, 2),
            new Among_js_1.Among("se", -1, 3), new Among_js_1.Among("en", -1, 2),
            new Among_js_1.Among("heden", 2, 1), new Among_js_1.Among("s", -1, 3)];
        this.a_4 = [
            new Among_js_1.Among("end", -1, 1), new Among_js_1.Among("ig", -1, 2),
            new Among_js_1.Among("ing", -1, 1), new Among_js_1.Among("lijk", -1, 3),
            new Among_js_1.Among("baar", -1, 4), new Among_js_1.Among("bar", -1, 5)
        ];
        this.a_5 = [
            new Among_js_1.Among("aa", -1, -1), new Among_js_1.Among("ee", -1, -1),
...
exports.DutchStemmer = DutchStemmer;
