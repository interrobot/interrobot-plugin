...
class HungarianStemmer extends BaseStemmer {
	...
	public constructor() {
		...
		this.a_0 = [new Among("cs", -1, -1), new Among("dzs", -1, -1),
		...
		this.a_2 = [
			...
			new Among("zz", -1, -1)];
		this.a_3 = [new Among("al", -1, 1),
			new Among("el", -1, 2)];
		this.a_4 = [new Among("ba", -1, -1),
