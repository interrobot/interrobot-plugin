...
class HtmlResultsTable {
    ...
    private downloadHandler: any;
    private downloadMenuHandler: any;
    private cellHandler: Function;
    private outlinkHandler: any;
    
    public static createElement(parentElement: HTMLElement, projectId: number, perPage: number,
        header: string, headings: string[], results: string[][], rowRenderer: Function, cellRenderer: {},
        cellHandler: Function, exportExtra: Object): HtmlResultsTable {

        const pagedTable: HtmlResultsTable = new HtmlResultsTable(projectId, perPage, header, headings,
            results, rowRenderer, cellRenderer, cellHandler, exportExtra);
    ...
    public constructor(projectId: number, perPage: number, header: string, headings: string[],
        results: any[], rowRenderer: Function, cellRenderer: Object, cellHandler: Function, exportExtra: Object) {
    ...
    private renderTableData(): string[] {
        ...
        for (let row of this.results.slice(this.resultsOffset, this.resultsOffset + this.perPage)) {
            ...
            if (this.rowRenderer) {
                const result: string[] = this.rowRenderer(rowCallbackData);
